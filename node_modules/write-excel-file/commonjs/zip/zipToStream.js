...
var _zip = _interopRequireDefault(require("archiver-node/zip"));
...
function zipToStream(files) {
  var archive = new _zip["default"]();
  for (var _i = 0, _Object$keys = Object.keys(files); _i < _Object$keys.length; _i++) {
    var key = _Object$keys[_i];
    archive.add(_buffer.Buffer.from(files[key]), key);
  }
