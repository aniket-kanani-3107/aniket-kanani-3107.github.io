...
MODULES = [
    {
        ...
        "vocab": [
            ...
            ("die Prämisse", "premise", "મૂલ ધારણા", "PRAY-mis-seh"),
    ...
    },
    {
        ...
        "vocab": [
            ...
            ("die Wertschöpfung", "value creation", "મૂલ્ય સર્જન", "VERT-sher-foong"),
    ...
    },
    {
        ...
        "vocab": [
            ...
            ("die Bildlichkeit", "imagery", "છબીવતતા", "BILD-likh-kite"),
...
def build_days():
    ...
    for module_index, module in enumerate(MODULES):
        ...
        for day in range(start, end + 1):
            ...
            # Offset each module by 3 to avoid identical first-day vocabulary windows.
